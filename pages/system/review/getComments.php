<?php
if ($ratingsNum <= 0) $ar['data'] = array();
else {
foreach ($ratingsList as $rK => $rO) {
	$ratingsIcon = '';
	for ($i = 1; $i <= 5; $i++) {
	...
	<div class="box-header with-border">
		...
		<div class="box-username">
			...
			<span class="coins-plus" title="Review của '.$rO['author']['name'].' đã cộng thêm cho '.$author['name'].' '.$rO['coins'].' điểm">
